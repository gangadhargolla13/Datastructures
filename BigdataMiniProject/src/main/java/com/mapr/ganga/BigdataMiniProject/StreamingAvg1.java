...
public class StreamingAvg1 {
    static Logger log = Logger.getLogger(StreamingAvg1.class.getName());
    ...
    public static void main(String[] args) {
        ...
        SparkConf sparkConf = new SparkConf().setAppName("StreamingAvg").setMaster("local[3]");
        ...
        JavaPairReceiverInputDStream<String, String> messages =
                KafkaUtils.createStream(ssc, args[0],"g1", topicMap);
